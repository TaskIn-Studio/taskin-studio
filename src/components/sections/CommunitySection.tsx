    ...
    <section id="community" className="py-16 md:py-24 bg-primary/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="max-w-xl mx-auto text-lg text-muted-foreground mb-10">
          Be the first to access upcoming tools, get updates, and connect with
          other makers.
        </p>
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
          <Button
            asChild
            size="lg"
            className="rounded-lg shadow-md hover:shadow-lg transition-shadow bg-sky-500 hover:bg-sky-600 text-white"
          >
          ...
          <Button
            asChild
            size="lg"
            className="rounded-lg shadow-md hover:shadow-lg transition-shadow bg-indigo-500 hover:bg-indigo-600 text-white"
          >
            <a href="#" target="_blank" rel="noopener noreferrer">
              {" "}
