...
import { Github, Twitter, Send, MessageCircle, Linkedin } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a
                  href="https://discord.gg/j3MzTsKf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm hover:text-primary transition-colors flex items-center"
                >
                  <MessageCircle size={16} className="mr-2" /> Discord
                </a>
              </li>
            </ul>
            <h3 className="text-lg font-semibold text-foreground mb-3 mt-4">
              Socials
            </h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <a
                  href="https://linkedin.com/company/taskin-studio"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm hover:text-primary transition-colors flex items-center"
                >
              ...
              <li>
                <a
                  href="https://github.com/maheshalyana/taskin-studio"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm hover:text-primary transition-colors flex items-center"
                >
